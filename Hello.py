...
background_image = pygame.transform.scale(
    pygame.image.load('C:/Users/eratu/Desktop/python projects/Class-33/Background.jpg').convert(),
    (SCREEN_WIDTH, SCREEN_HEIGHT))

penguin_image = pygame.transform.scale(
    pygame.image.load('C:/Users/eratu/Desktop/python projects/Class-33/luffy.jpeg').convert_alpha(), (200, 200))
